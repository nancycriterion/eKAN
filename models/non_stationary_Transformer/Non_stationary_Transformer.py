...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.seq_len = configs.batch_length
        ...
        self.tau_learner = Projector(enc_in=configs.enc_in, seq_len=configs.batch_length, hidden_dims=configs.p_hidden_dims,
                                     hidden_layers=configs.p_hidden_layers, output_dim=1)
        self.delta_learner = Projector(enc_in=configs.enc_in, seq_len=configs.batch_length,
                                       hidden_dims=configs.p_hidden_dims, hidden_layers=configs.p_hidden_layers,
                                       output_dim=configs.batch_length)
